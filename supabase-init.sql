...
CREATE TABLE employees (
  ...
  team TEXT CHECK (team IN ('voha') OR team IS NULL),
...
CREATE TABLE operations (
  ...
  team TEXT NOT NULL CHECK (team IN ('voha')),
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE expenses (
  ...
  team_id TEXT CHECK (team_id IN ('voha') OR team_id IS NULL),
...
CREATE TABLE leads (
  ...
  manager_id TEXT NOT NULL REFERENCES employees(id),
  team_id TEXT NOT NULL CHECK (team_id IN ('voha')),
  amount NUMERIC(12, 2),
  created_by TEXT,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
VALUES
  ('philipp_plein', 'Philipp Plein', 'manager', 'voha', 850, 15, 10, 0, FALSE, 'philipp_plein'),
  ('kolomoyskiy', 'Коломойский', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'kolomoyskiy'),
  ('an_225', 'АН-225', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'an_225'),
  ('matros', 'Матрос', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'matros'),
  ('tefal', 'Tefal', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'tefal'),
  ('reno', 'Reno', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'reno'),
  ('hugo', 'HUGO', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'hugo'),
  ('shura', 'Шура', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'shura'),
  ('shtil', 'Штиль', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'shtil'),
  ('ceo', 'CEO', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'ceo'),
  ('malish', 'Малыш', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'malish'),
  ('lada', 'LADA', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'lada'),
  ('piton', 'Питон', 'manager', 'voha', 850, 15, 10, 0, FALSE, 'piton'),
  ('adidas', 'Adidas', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'adidas'),
  ('exel', 'EXEL', 'manager', 'voha', 850, 15, 10, 0, FALSE, 'exel'),
  ('valeryana', 'Валерьяна', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'valeryana'),
  ('stone_island', 'Stone Island', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'stone_island'),
  ('cp_company', 'C.P Company', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'cp_company'),
  ('ufc', 'UFC', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'ufc'),
  ('tyazhik', 'Тяжик', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'tyazhik'),
  ('borchik', 'Борчик', 'manager', 'voha', 350, 15, 10, 0, FALSE, 'borchik'),
