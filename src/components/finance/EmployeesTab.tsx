            ...
            {isAdmin && (
              <>
                <Button
                  ...
                  title="Синхронизирует с начальными данными"
                >
                  {isSyncing ? (
                    <>
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-green-50 border-blue-200">
        ...
        <CardContent className="text-sm text-gray-700 space-y-3">
          <div className="bg-white p-3 rounded-lg border border-blue-200">
            <p className="font-semibold text-blue-900 mb-2 flex items-center gap-2"><Edit className="w-4 h-4" /> Редактирование:</p>
            <p>1. Нажмите карандаш напротив сотрудника</p>
            <p>2. Измените данные в окне</p>
            <p>3. Нажмите <strong>"Сохранить в БД"</strong> → данные обновятся на всех устройствах</p>
            <p>4. Или нажмите <strong>"Отменить"</strong> → изменения не сохранятся</p>
          </div>

          <div className="bg-white p-3 rounded-lg">
            <p className="font-semibold mb-1 flex items-center gap-2"><FileText className="w-4 h-4" /> Обозначения:</p>
            <p><strong>Ставка:</strong> Минимальная гарантированная ЗП (350 USDT для менеджеров)</p>
            <p><strong>% растам.:</strong> Процент с первого чека (растаможки)</p>
            <p><strong>% добив:</strong> Процент с дополнительных продаж (добивов)</p>
            <p><strong>% прибыль:</strong> Процент от чистой прибыли (не используется)</p>
            <p><strong>Фикс:</strong> Фиксированная выплата за период (Фотошоп)</p>
          </div>
        </CardContent>
      </Card>
