    ...
    <div className="space-y-6 p-6 bg-gradient-to-br from-slate-50 via-white to-blue-50 min-h-screen">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Полная аналитика вашего бизнеса</p>
        </div>
        <PeriodSelector />
      </div>
          ...
          <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                <br />
                <span className="text-green-600 font-medium">✓ Показаны полные 100% расходы.</span>
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="p-4 bg-purple-100 rounded-lg border-2 border-purple-500">
                ...
                <p className="text-sm text-purple-700 mt-1">
                  Сумма {periodExpenses.length} расходов (без зарплат, полные 100%)
                </p>
              </div>
            </div>
          </DialogContent>
              ...
              <>
                <ResponsiveContainer width="100%" height={350}>
                  <LineChart data={teamDailyDynamics} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                    <defs>
                      <linearGradient id="colorVoha" x1="0" y1="0" x2="0" y2="1">
              ...
              <div className="p-4 bg-red-50 rounded-lg border-2 border-red-200">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between p-2 bg-white rounded">
                    ...
                    <span className="font-semibold">${formatUSDT(employees.filter(e => e.role === 'it').reduce((sum, emp) => {
                      return sum + (emp.fixedPay || emp.salary);
                    }, 0) * 0.5)}</span>
                  </div>
